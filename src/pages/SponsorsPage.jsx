            ...
            <div className='row'>
              ...
              <div className='col-md-6'>
                <p className='lead mb-3'>
                  TEDxUWA aims to spread good ideas among the UWA community. Creating a synergy of
                  ideas between different disciplines and people
                </p>
              </div>
            </div>
          </div>
            ...
            <div className='row'>
              <div className='col-md-6 mb-4 mb-md-0'>
                ...
                <p className='lead text-muted'>
                  Contact us to discuss how you can help make a difference with TEDxUWA. If your
                  business specialises in venue, catering, marketing, signage, production or
                  merchendise any assistance would be greatly appreciated.
                </p>
                <a href={PROSPECTUS_LINK}>
                  <button className='btn btn-dark mt-3'>Download our prospectus</button>
                </a>
              </div>
              <div className='col-md-6'>
                <ContactForm noTitle />
