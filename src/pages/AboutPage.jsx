  ...
  render() {
    return (
      <div className="about page">
        <PageHeader title="About Us" lead="We seek to find and share ideas from arround the world and closer to home with the UWA community. We are students from the University of Western Australia , we are TEDxUWA."/>
