...
export default class ContactForm extends Component {
  ...
  handleSubmit = (e) => {
    ...
    const body = `${this.state.message}%0D%0A%0D%0ABy ${this.state.name} at ${this.state.email}.%0D%0ASent from the TEDxUWA Website.`;
    const url = `mailto:tedxuwa@gmail.com?subject=${subject}&body=${body}`;
